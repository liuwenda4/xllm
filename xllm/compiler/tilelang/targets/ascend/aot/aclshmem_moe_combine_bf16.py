...
from xllm.python.kernels_npu.tilelang import aclshmem_moe_combine_bf16 as kernel_impl
from xllm.python.kernels_npu.tilelang.aclshmem_moe_combine_bf16 import (
    build_aclshmem_moe_combine_bf16_kernel,
)
...
class AclShmemMoeCombineBf16Kernel(TilelangKernel):
    KERNEL_NAME = "aclshmem_moe_combine_bf16"
    DISPATCH_SCHEMA = [
    ...
    def generate_source(
        ...
        prim_func = build_aclshmem_moe_combine_bf16_kernel(
...
if os.environ.get("XLLM_ENABLE_ACLSHMEM_MOE_AOT", "0") == "1":
    AclShmemMoeCombineBf16Kernel = register_kernel(AclShmemMoeCombineBf16Kernel)
